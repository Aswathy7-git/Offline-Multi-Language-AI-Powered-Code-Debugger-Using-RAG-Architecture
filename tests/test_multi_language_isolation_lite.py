...
async def verify_isolation():
    ...
    # Mock LLM to avoid loading time
    agents.llm = None 
    ...
    print("\n--- MULTI-LANGUAGE ISOLATION TEST (LITE) ---\n")
    ...
    for case in test_cases:
        ...
        if bug_type == case['expected_bug']:
            print(f"  ✅ [PASS]")
        elif status == "Stable System" and (case['expected_bug'] == "None" or not bug_type or bug_type == "None"):
             print(f"  ✅ [PASS]")
        else:
